<div class="">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                    ...
                    <article class="break-inside-avoid rounded-3xl bg-white shadow-lg ring-1 ring-black/5 p-6">
                        <header class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="flex text-yellow-400 text-sm tracking-tight" aria-label="5 star rating">
                                    ★★★★★
                                </div>
                            </div>
                ...
                <div class="embla__slide">
                    <article class="break-inside-avoid rounded-3xl bg-[#fbbb0c] text-white shadow-lg p-6">
                        <header class="flex items-center gap-3">
                            ...
                            <!-- Facebook (f) -->
                            <svg class="ml-auto size-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path
        ...
        <div id="bottom-to-top-slide" class="overflow-hidden">
        ...
        <div id="bottom-to-bottom-slide" class="overflow-hidden hidden md:block">
