<!-- Dark Footer -->
    <section class="bg-black relative -z-[0]">
        ...
        <div class="container mx-auto max-w-6xl px-5 md:px-10 py-20">
            <div class="text-center mb-20">
                ...
                <div class="flex items-center gap-3 mt-14 justify-center">
                    <a href="">
                        <img src="{{ Vite::asset('resources/images/playstore download.png') }}" alt="" class="h-8 md:h-10 border border-white/20 rounded-md"></a>
                    <a href="">
                        <img src="{{ Vite::asset('resources/images/appstore download.png') }}" alt="" class="h-8 md:h-10 border border-white/20 rounded-md"></a>
                </div>
            </div>
            <!-- Footer -->
                ...
                <div class="container mx-auto max-w-6xl">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
                        ...
                        <div class="lg:col-span-2">
                            <a href="/">
                                <img src="{{ Vite::asset('resources/images/logo wide white.png') }}" class="h-10 md:h-14 mb-5" />
                            </a>
                            ...
                            <div class="text-neutral-400 mb-4">
                                <p> <span class="font-semibold text-white">Branch Offices:</span> Kano, Abuja, Ebonyi
                        ...
                        <!-- For Individuals -->
                        <div>
                            <h4 class="text-lg font-semibold mb-4">For Individuals</h4>
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-neutral-400 mb-6">
                                ...
                                <li><a href="/press" class="hover:text-white transition">Press and Media</a></li>
                            </ul>
                        </div>
                        <!-- Resources -->
                        <div>
                            ...
                            <ul class="space-y-2 text-neutral-400">
                                ...
                                <li><a href="/whistleblower" class="hover:text-white transition">Whistleblower Policy</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center gap-5">
                        <div class="flex items-center gap-2">
                            <img src="{{ Vite::asset('resources/images/qr.png') }}" alt="Qr code to download the DgnRavePay App"
                                class="h-12 md:h-14">
                            <div class="">
