    ...
    <x-guest-layout>
                ...
                <div class="custom-container mx-auto  px-5 md:px-10">
                    <div class="text-center mb-10">
                        <h1 class="capitalize text-center mb-5">
                            Create, send, and get paid faster with smart invoicing
                        </h1>
                        <p class="md:font-[500] md:text-lg lg:text-xl mb-10">Manage invoices, track payments, and automate
                            collections all within DgnRavePay Business Suite.</p>
                        <div class="">
                            <a href="#"
                    ...
                    <img src="{{ Vite::asset('resources/images/black-hand-holding-phone-invoice.png') }}"
        ...
        <section class="my-28">
            <div class="custom-container mx-auto  px-5 md:px-10">
                <div class="mb-10 px-5 md:px-10" data-aos="fade-up">
                    <h2 class="text-left mb-5">Invoicing made effortless for your growing business</h2>
                </div>
                <div class="grid md:grid-cols-3 gap-5 mt-10">
                    <div class="bg-primary rounded-xl flex flex-col justify-between hover:!scale-[1.02] transition-transform"
                        ...
                        <div class="px-4 py-5 md:px-5 md:py-6">
                            <h6 class="font-bold text-xl md:text-2xl mb-1">Create in seconds</h6>
                            <p>Generate invoices instantly and share via link or email</p>
                        </div>
                        <img src="{{ Vite::asset('resources/images/invoice-1.png') }}" alt=""
                            class="mt-5 ml-auto w-4/5">
                    </div>
                    <div class="bg-stone-200 rounded-xl flex flex-col justify-between relative overflow-hidden hover:!scale-[1.02] transition-transform"
                        data-aos="fade-up">
                        <div class="px-4 py-5 md:px-5 md:py-6">
                            <h6 class="font-bold text-xl md:text-2xl mb-1">Track payments</h6>
                            <p>See who’s paid and who hasn’t in real-time</p>
                        </div>
                        <div class="h-full flex items-center">
                            <img src="{{ Vite::asset('resources/images/invoice-2.png') }}" alt=""
                                class="w-[90%] mx-auto">
                        </div>
                    </div>
                    <div class="bg-stone-900 text-white rounded-xl flex flex-col justify-between relative overflow-hidden hover:!scale-[1.02] transition-transform"
                        data-aos="fade-up">
                        <div class="px-4 py-5 md:px-5 md:py-6">
                            <h6 class="font-bold text-xl md:text-2xl mb-1">Get paid faster </h6>
                            <p>Customers pay you instantly via DgnRavePay wallet.</p>
                        </div>
                        <img src="{{ Vite::asset('resources/images/invoice-3.png') }}" alt="" class="ml-auto">
                    </div>
                </div>
        </section>
        ...
        <section class="my-28 custom-container mx-auto px-5 md:px-10 space-y-20 md:space-y-40">
            <div class="grid lg:grid-cols-2 gap-10 items-center">
                <div class="">
                    <h4 class="text-xl md:text-2xl lg:text-[48px] font-bold mb-5">Create Invoices Instantly</h4>
                    <p class="">Build beautiful invoices in seconds. Add items, taxes, and payment terms with just a
                        few clicks.</p>
                </div>
                <img src="{{ Vite::asset('resources/images/create-invoices.png') }}" alt="vector line" class="w-full" />
            </div>
            <div class="grid lg:grid-cols-2 gap-10 items-center">
                <div class="lg:order-2">
                    <h4 class="text-xl md:text-2xl lg:text-[48px] font-bold mb-5">Get Paid Faster</h4>
                    <p class="">Customers can pay directly from your invoice via DgnRavePay wallet or bank transfer no
                        extra setup needed.</p>
                </div>
                <img src="{{ Vite::asset('resources/images/get-paid.png') }}" alt="vector line" class="w-full" />
            </div>
            <div class="grid lg:grid-cols-2 gap-10 items-center">
                <div class="">
                    <h4 class="text-xl md:text-2xl lg:text-[48px] font-bold mb-5">Track and Automate Collections
                    </h4>
                    <p class="">Stay on top of your cashflow. Automatically track overdue payments and send gentle
                        reminders.</p>
                </div>
                <img src="{{ Vite::asset('resources/images/track-automate.png') }}" alt="vector line" class="w-full" />
            </div>
        </section>
