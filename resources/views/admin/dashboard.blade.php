        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <a href="{{ route('admin.testimonials.index') }}"
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div class="h-10 w-10 rounded-xl bg-primary/20 text-primary-3 grid place-items-center font-bold">T</div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="rounded-2xl bg-white/90 backdrop-blur shadow ring-1 ring-black/5 p-5 lg:col-span-2"
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="font-semibold">Content activity (last 7 days)</h3>
                ...
                <ul class="mt-3 space-y-2 text-sm">
                    @foreach ($recent ?? [] as $item)
                        <li class="flex items-center justify-between gap-3">
                            ...
                            <span class="text-xs text-gray-500 whitespace-nowrap">{{ $item['when'] }}</span>
                        </li>
                    @endforeach
                    @if (empty($recent))
            ...
            <!-- Top tags -->
            <div class="rounded-2xl bg-white/90 backdrop-blur shadow ring-1 ring-black/5 p-5 lg:col-span-1">
