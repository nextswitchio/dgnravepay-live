...
const navbarProductPersonal = `
                                    ...
                                    <a href="/" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('user.png')}" alt="user icon" class="size-6">
                                        <div class="text-left">
                                    ...
                                    <a href="/virtual" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('pos_terminal.png')}" alt="pos terminal icon" class="size-6">
                                    ...
                                    <a href="/savings" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('savings.png')}" alt="savings icon" class="size-6">
                                    ...
                                    <a href="#" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('loan.png')}" alt="loan icon" class="size-6">
                                    ...
                                    <a href="#" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('hotel-bed.png')}" alt="hotel bed icon" class="size-6">
...
const navbarProductBusiness = `
                                    <a href="/business" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('briefcase.png')}" alt="briefcase icon" class="size-6">
                                        <div class="text-left">
                                    ...
                                    <a href="#" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('pos_terminal.png')}" alt="POS & Terminals icon"
                                            class="size-6">
                                    ...
                                    <a href="#" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('graph-up.png')}" alt="Business graph up icon"
                                            class="size-6">
                                    ...
                                    <a href="#" class="rounded-xl p-3 flex items-start  gap-5">
                                        <img src="${getImageUrl('invoice.png')}" alt="invoice icon" class="size-6">
