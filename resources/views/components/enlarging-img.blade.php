<div class="overflow-hidden -z-[0] flex justify-center relative py-12 gap-3 md:gap-5 items-center">
    <div class="space-x-4 md:space-x-0 md:space-y-4 w-[100px] min-w-[100px] md:min-w-[200px] md:w-[200px]">
