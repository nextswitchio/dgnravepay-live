<x-guest-layout>
    <section class="min-h-screen pt-24 lg:pt-28 flex items-center">
        <div class="custom-container mx-auto  px-5 md:px-10 w-full">
                ...
                <div class="hidden lg:block order-last lg:order-first">
                    <div class="relative overflow-hidden rounded-3xl shadow-xl ring-1 ring-black/5">
                        ...
                        <div class="absolute z-20 inset-0 p-8 flex flex-col justify-end text-primary-3">
                            ...
                            <h2 class="text-white/95 text-3xl font-semibold leading-tight">Create your account</h2>
                            <p class="text-white/80 mt-2">Join thousands banking smarter with DgnRavePay.</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="bg-white/80 backdrop-blur-sm shadow-2xl ring-1 ring-black/5 rounded-2xl p-6 sm:p-8">
                        <div class="mb-6">
                            ...
                            <p class="text-gray-500 mt-1">Already have an account?
                                <a href="{{ route('login') }}" class="text-primary hover:underline font-medium">Log
                                    in</a>
                            </p>
                        </div>
